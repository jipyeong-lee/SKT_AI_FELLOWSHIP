...
tag2id = {'I-LOC': 0, 'B-LOC': 1, 'I-PER': 2, 'O': 3, 'B-PER': 4}
id2tag = {0: 'I-LOC', 1: 'B-LOC', 2: 'I-PER', 3: 'O', 4: 'B-PER'}

model = AutoModelForTokenClassification.from_pretrained('koelectra_small', num_labels=len(unique_tags))
model.to(device)
