...
MODEL_NAME = 'beomi/kcelectra-v2022-dev'
device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')
tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME)

unique_tags = {'B-LOC', 'B-PER', 'I-LOC', 'I-PER', 'O'}
tag2id = {'B-PER': 0, 'O': 1, 'I-PER': 2, 'B-LOC': 3, 'I-LOC': 4}
id2tag = {0: 'B-PER', 1: 'O', 2: 'I-PER', 3: 'B-LOC', 4: 'I-LOC'}

model = AutoModelForTokenClassification.from_pretrained('kcelectra_small', num_labels=len(unique_tags))
model.to(device)
